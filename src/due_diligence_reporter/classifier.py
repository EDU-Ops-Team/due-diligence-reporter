...
def classify_by_keywords(filename: str) -> tuple[str, float]:
    ...
    if "security due diligence" in name or "security diligence" in name:
        return "security_due_diligence_report", 0.95
...
- alpha_phasing_plan_report: Phase 1 Phase 2 workbook generated by the DD workflow
...
- security_due_diligence_report: Security Due Diligence memo generated by the DD workflow
