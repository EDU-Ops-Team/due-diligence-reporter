...
def test_prompt_v4_keeps_first_round_contract() -> None:
    ...
    required_phrases = [
        ...
        "does not render in",
        "After `prepare_due_diligence_data` returns success, stop.",
        "apply_opening_plan_skill",
        "Opening Plan is a normal DD enrichment step",
        "apply_alpha_capacity_analysis_skill",
        "Capacity comes from Alpha Capacity",
